...
namespace Netherite.Handlers
{
    internal class UpdateHandler
    {
        ...
        {
            var latest = webClient.DownloadString("https://raw.githubusercontent.com/NetheriteDeveloper/Website/main/download/version.txt");
        ...
        public static void Update()
        {
            ...
            new WebClient().DownloadFile("https://github.com/NetheriteDeveloper/Website/raw/main/download/Netherite.exe", path);
